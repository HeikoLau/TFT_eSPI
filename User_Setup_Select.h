...
//#include <User_Setups/XIAO_RP2040_GC9A01.h>  // Setup file configured for XIAO RP2040 with round GC9A01 240x240
#include <User_Setups/XIAO_GC9A01.h>  // Setup file configured for XIAO with round GC9A01 240x240
